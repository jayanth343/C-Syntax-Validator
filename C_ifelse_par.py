...
from C_if_lex import tokens
from C_if_lex import data

flag = 0

def p_if(p):
    '''
    if_statement    : IF LBRACE conditions RBRACE LFLOWER statements RFLOWER ELSE LFLOWER statements RFLOWER
                      
                    | IF LBRACE conditions RBRACE LFLOWER statementSingle RFLOWER ELSE LFLOWER statementSingle RFLOWER
